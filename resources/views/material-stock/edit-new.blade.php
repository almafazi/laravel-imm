...
@section('content')
    ...
    <h5 class="fw-bold py-3 mb-4">
        ...
        Kelola Stock {{ $material_stock->material->name }}
    </h5>
    ...
    <form action="{{ route('material-stock.update') }}" method="post" id="form">
        ...
        <div class="col-md-6 d-flex justify-content-between mb-4">
            <a href="{{ route('material-stock.index', ['material_id' => $material_stock->material->id]) }}"
